...
🤖 **Agents too, not just humans** _(beta)_ — a robotic-duck landing split opens the Agents family: what your AI coding agents cost, a daily digest of what they did, and a security audit of your agent setup — computed locally from Claude Code/OpenClaw session logs, transcripts never leave your machine
