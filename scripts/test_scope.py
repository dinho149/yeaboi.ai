...
AREAS: tuple[Area, ...] = (
    ...
    Area(
        ...
        src=(
            "frontend/",
            # Generated by Python, read by TypeScript. Listed here so a
            # regenerated contract selects the web tests, and in the `web` job
            # below so it also selects the Node --check that renders it.
            "contracts/web/",
            "src/yeaboi/web/",
...
JOBS: tuple[Job, ...] = (
    Job("web", ("frontend/", "contracts/web/", "src/yeaboi/web/", "scripts/gen_web_types.py")),
