"""Cross-source conflict cards: the board and the code disagree, out loud.
...
module adds the mirror the reader kept having to spot by hand — **a ticket
closed as done while a pull request that names it is still open** — and it
