...
tools mutate external systems (Jira, Azure DevOps, Linear, Confluence, Notion) and are
...
TOOL_RISK: dict[str, ToolRisk] = {
    ...
    # Linear (cycles are auto-generated by Linear, so there is no create-cycle twin
    # of jira_create_sprint — issue write-back is the whole write surface)
    "linear_read_board": ToolRisk.READ,
    "linear_fetch_velocity": ToolRisk.READ,
    "linear_fetch_active_cycle": ToolRisk.READ,
    "linear_create_issue": ToolRisk.WRITE,
    # Confluence
